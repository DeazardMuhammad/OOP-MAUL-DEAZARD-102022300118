    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                throw new TaskNotSelectedException("Pilih Yang Benar");
